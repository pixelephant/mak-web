...
<h2 class="hiba">
   <?php if ($_REQUEST['hibakod']) 
        ...
        echo "A (teszt) vásárlás nem indult el vagy a banki válasz nem értelmezhetõ.";
   ?>
</h2>
...
<table class="eredmenytabla1">
  ...
  <tr>
    <th>Hibakód:</th>
    <td>
        <?php echo $_REQUEST['hibakod'] ?>
        <?php if (getMessageText($_REQUEST['hibakod'])) { ?>
           - <?php echo getMessageText($_REQUEST['hibakod']) ?>
        <?php } ?>
    </td>
  </tr>
  <?php } ?>
