...
<form method="post" action="<?php echo dirname($_SERVER['SCRIPT_NAME']) ?>/fiz2.php">
    ...
    <table class="input">
      ...
      <tr>
        <th>Összeg</th>
        <td><input type="text" name="osszeg" value="240" size="15" maxlength="10" class="text"/></td>
      </tr>
      <tr>
        <th>Devizanem</th>
      ...
      <tr>
        <th>Vevõ név</th>
        <td><input type="text" name="vevoNev" size="40" value="Thomas Customer" class="text"/></td>
      </tr>
      <tr>
        <th>Vevõ lakcím *</th>
      ...
      <tr>
        ...
        <td><input type="text" name="ertesitoMail" value="tommy@customers.com" size="40" class="text"/></td>
      </tr>
      <tr>
        <th>Vevõ telefon *</th>
    ...
    <input type="hidden" name="func" value="fiz2ketlepcsos">
