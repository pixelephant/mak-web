...
<form method="post" action="<?php echo dirname($_SERVER['SCRIPT_NAME']) ?>/fiz3.php">
    ...
    <table class="input">
      ...
      <tr>
        <th>Összeg</th>
        <td><input type="text" name="osszeg" value="360" size="15" maxlength="10" class="text"/></td>
      </tr>
      <tr>
        <th>Devizanem</th>
      ...
      <tr>
        ...
        <td><input type="text" name="shopMegjegyzes" value="Teszt üzemû regisztrált fizetés - PHP" size="40"  class="text"/></td>
      </tr>

      <tr>
        <th>Vissza link</th>
        <td><input type="text" name="backURL" value="<?php echo 'http://' . $_SERVER['SERVER_NAME'] . ':' . $_SERVER['SERVER_PORT'] . dirname($_SERVER['SCRIPT_NAME']) ?>/fiz3.php?func=fiz3fizreg" size="40"  class="text"/><br/>
    ...
    <input type="hidden" name="ugyfelRegisztracioKell" value="false" />

    <input type="hidden" name="func" value="fiz3fizreg"/>            
