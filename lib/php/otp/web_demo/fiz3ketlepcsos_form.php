...
<form method="post" action="<?php echo dirname($_SERVER['SCRIPT_NAME']) ?>/fiz3.php">
    ...
    <table class="input">
      ...
      <tr>
        <th>Összeg</th>
        <td><input type="text" name="osszeg" value="340" size="15" maxlength="10" class="text"/></td>
      </tr>
      <tr>
        <th>Devizanem</th>
      ...
      <tr>
        ...
        <td><input type="checkbox" name="ugyfelRegisztracioKell" value="true" class="check"/></td>
      </tr>
      <tr>
      ...
      <tr>
        <th>Kétlépcsõs fizetés</th>
        <td>
          <input type="radio" name="ketlepcsosFizetes" value="true" checked="checked" id="ketlepcsos"/>
          <label for="ketlepcsos">Igen</label> &nbsp;
          <input type="radio" name="ketlepcsosFizetes" value="false" id="egylepcsos"/>
          <label for="egylepcsos">Nem</label> &nbsp;
          <input type="radio" name="ketlepcsosFizetes" value="" id="alapertelmezett"/>
          <label for="alapertelmezett"><i>Bolti alapértelmezett mód</i></label>
        </td>
      </tr>

      <tr>
        <th>Vissza link</th>
        <td><input type="text" name="backURL" value="<?php echo 'http://' . $_SERVER['SERVER_NAME'] . ':' . $_SERVER['SERVER_PORT'] . dirname($_SERVER['SCRIPT_NAME']) ?>/fiz3.php?func=fiz3ketlepcsos€" size="40"  class="text"/><br/>
    ...
    <input type="hidden" name="func" value="fiz3ketlepcsos"/>            
