...
<form method="post" action="<?php echo dirname($_SERVER['SCRIPT_NAME']) ?>/fiz3.php">
    ...
    <table class="input">
      ...
      <tr>
        <th>Összeg</th>
        <td><input type="text" name="osszeg" value="320" size="15" maxlength="10" class="text"/></td>
      </tr>
      <tr>
        <th>Devizanem</th>
      ...
      <tr>
        ...
        <td><input type="text" name="shopMegjegyzes" value="Teszt üzemû regisztrálás és fizetés - PHP" size="40"  class="text"/></td>
      </tr>
    ...
    <input type="hidden" name="func" value="fiz3regfiz"/>            
