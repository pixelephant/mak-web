/*
 * a register.php oldalon lévő
 * kliens oldali műveleteket tartalmazza,
 * valamint biztosítja az ajax kommunikációt
 * a register.php oldalra vonatkozóan
 */
	...
	*/
	...
	$("#registerform").validate({
		...
		messages: {
			...
			"email" : {
				remote : "Az email címmel már regisztráltak"
			}
		  }
	});
	...
	$("#memberform").validate({
		...
		rules : {
			...
			"terms4" : {
				required : "#standardMember:checked, #komfortMember:checked"
			},
		},
		messages : {
...
/*	$("#toStep2").click(function(){
	...
	$("#standardMember,#komfortMember").click(function(){
		$("#komfortTerms").show();
	});
	
	$("#diszkontMember").click(function(){
		$("#komfortTerms").hide();
	});
