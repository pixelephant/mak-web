...
$(function() {
				...
				$.post("lib/php/reg.php",{
					...
					if(resp != null && resp != 'null'){
						...
						if(response.nem == "C"){
							...
							$("#coName").val(response.allando_irsz);
							$("#coDate").val(response.allando_irsz);
							$("#coZip").val(response.allando_irsz);
							$("#coCity").val(response.allando_irsz);
							$("#coName").val(response.allando_irsz);
							$("#coAddress").val(response.allando_irsz);
	...
	$("#paymentform").validate({
		submitHandler: function(form) {
			...
			var paymentmethodRadio = $("input[name='platetype']:checked").attr("id");
