...
$(function() {
	...
	$("#levelButton").click(function(e){
		...
		$("#type").html(" - magasabb tagsági szint választáshoz");
	...
	$("#memberform input[type='radio']").click(function(){
		...
		$(".sum").html(addSpaces(parseInt(p) - parseInt(cp)) + " Ft/év");
		$("#osszeg").val(parseInt(p) - parseInt(cp));
