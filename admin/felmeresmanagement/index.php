		...
		<div id="inputs">
			<form>
				<fieldset>
					<h3>Sorsolás</h3>
					<div id="gombok">
						<div class="row"><label for="darab">Hány felhasználót sorsoljunk ki?</label><input type="text" name="darab" id="darab"/></div>
						<div class="row"><label for="kerdes">Melyik kérdés?</label><input type="text" name="kerdes" id="kerdes"/></div>
						<div class="row"><label for="valasz">Jó válasz sorszáma:</label> 
						...
						<input type="button" id="sorsolas" value="Sorsolás">
						<br />
					</div>
				</fieldset>
			</form>
