...
description:"does not contain",operator:"NOT LIKE"}],numopts:["eq","ne","lt","le","gt","ge","nu","nn"],stropts:["eq","ne","bw","bn","ew","en","cn","nc","nu","nn"],_gridsopt:[],groupOps:["AND","OR"],groupButton:true,ruleButtons:true},k||{});return this.each(function(){if(!this.filter){this.p=o;if(this.p.filter===null||this.p.filter===undefined)this.p.filter={groupOp:this.p.groupOps[0],
